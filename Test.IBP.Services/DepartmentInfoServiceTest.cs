...
namespace Test.IBP.Services
{
    
    
    /// <summary>
    ///这是 DepartmentInfoServiceTest 的测试类，旨在
    ///包含所有 DepartmentInfoServiceTest 单元测试
    ///</summary>
    [TestClass()]
    public class DepartmentInfoServiceTest
    {
        ...
        /// <summary>
        ///GetDepartmentTreeFromDatabase 的测试
        ///</summary>
        [TestMethod()]
        [DeploymentItem("IBP.Services.dll")]
